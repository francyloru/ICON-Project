...
def main():
    ...
    parser.add_argument("--find_models", action="store_true", help="Trova i modelli migliori per ogni città allenando tutti i modelli su tutte le città e testandoli su 2025")
    ...
    if args.train_and_test_xgboost:
        ...
        # print(xgboost_train_and_test.predizione_annuale('Potenza', 2026))
        print("RMSE per l'anno 2025 con xgboost:",xgboost_train_and_test.train_and_test(path_file, 'TMEDIA °C', localita, 2025))
    ...
    if args.find_scheduling:
        # print(linear_regression_train_and_test.predizione_annuale('Bari', 2026))
